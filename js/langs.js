let python = {
    ...
    links: [
        ...
        'https://stepik.org/catalog/52?language=ru'
    ]
}
...
let c = {
    ...
    wide: '',
    links: [
        'https://vse-kursy.com/read/666-yazyk-programmirovaniya-c-s-nulya-uroki-dlya-nachinayuschih.html',
        'https://stepik.org/course/3078/promo',
        'https://stepik.org/course/73618/promo'
    ]
}
...
let swift = {
    ...
    links: [
        'https://swiftbook.ru/',
        'https://stepik.org/course/51900/promo',
        'https://stepik.org/course/89377/promo'
    ]
}
...
let visualbasic = {
    ...
    wide: '',
    links: [
        'https://docs.microsoft.com/ru-ru/visualstudio/get-started/visual-basic/tutorial-console?view=vs-2019',
        'http://visualprogs.ru/lesson.html',
        'https://labs-org.ru/visual-basic/'
    ]
}
...
let obj_c = {
    ...
    wide: '',
    links: [
        'https://habr.com/ru/post/107126/',
        'https://coderlessons.com/tutorials/kompiuternoe-programmirovanie/izuchit-tsel-c-programmirovanie/objective-c-kratkoe-rukovodstvo',
        'https://vse-kursy.com/read/1289-uroki-objective-c-besplatnye-video-dlya-samostoyatelnogo-obucheniya.html'
    ]
}
...
let MACOS = [swift, obj_c];
let WINDOWS = [python, cpp, csharp, c, javascript, visualbasic, pascal];
let LINUX = [python, cpp, csharp, c, java, ruby];
let MICRO = [python, cpp, c, java, javascript];
let BASE = [python, sql];
let IIMO = [python, cpp, java, javascript];